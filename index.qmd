...
scenario_label_converter <- c(
  ...
  "ssp245_2050" = "SSP2-4.5 (2050)", # Example, add if you have it
  "ssp245_2100" = "SSP2-4.5 (2100)", # Example, add if you have it
  "ssp370_2050" = "SSP3-7.0 (2050)", # Example, add if you have it
  "ssp370_2100" = "SSP3-7.0 (2100)", # Example, add if you have it
...
if (nrow(auc_improvement_df) > 0 && 
  ...
  plot_auc_improvement <- ggplot(auc_improvement_df, aes(x = specialization_type, y = AUC_improvement, fill = specialization_type)) +
    ...
    labs(
      ...
      subtitle = "Comparing Combined (Host+Env) vs. Environment-Only Models",
      x = "Anemonefish Specialization Type (≤3 hosts = Specialist; >3 hosts = Generalist)", # Updated X-axis label
...
if (!is.null(df_fish_comparison) && nrow(df_fish_comparison) > 0 && "AUC_test_CV" %in% names(df_fish_comparison)) {
  ...
  print(
    df_fish_comparison %>%
      ...
      dplyr::summarize(mean_auc = mean(AUC_test_CV, na.rm = TRUE), .groups = 'drop') %>%
